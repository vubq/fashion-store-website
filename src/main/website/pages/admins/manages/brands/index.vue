...
import {createOrUpdateBrand, getAllBrand, getBrandById} from '~/server/services/brand'
...
<template>
  <UDashboardPage>
    <UDashboardPanel grow>
      <UDashboardNavbar title="Thương hiệu" :badge="totalRows">
        <template #right>
          <UInput
            ref="input"
      ...
      <UDashboardModal
        ...
        :title="state.id ? 'Cập nhật Thương hiệu' : 'Thêm mới Thương hiệu'"
      ...
      >
        ...
        >
          <UFormGroup label="Tên Thương hiệu" name="name">
            <UInput v-model="state.name" placeholder="Dior, Gucci,..." autofocus/>
          </UFormGroup>

          <UFormGroup label="Mô tả" name="description">
            <UInput v-model="state.description" placeholder="Dior, Gucci,..."/>
          </UFormGroup>
