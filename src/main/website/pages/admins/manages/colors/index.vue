...
import {createOrUpdateColor, getAllColor, getColorById} from '~/server/services/color'
...
<template>
  <UDashboardPage>
    <UDashboardPanel grow>
      <UDashboardNavbar title="Màu sắc" :badge="totalRows">
        <template #right>
          <UInput
            ref="input"
      ...
      <UDashboardModal
        ...
        :title="state.id ? 'Cập nhật Màu sắc' : 'Thêm mới Màu sắc'"
      ...
      >
        ...
        >
          <UFormGroup label="Tên Màu sắc" name="name">
            <UInput v-model="state.name" placeholder="Xanh, đỏ,..." autofocus/>
          </UFormGroup>

          <UFormGroup label="Mô tả" name="description">
            <UInput v-model="state.description" placeholder="Xanh, đỏ,..."/>
          </UFormGroup>
