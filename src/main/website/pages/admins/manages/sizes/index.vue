...
import {createOrUpdateSize, getAllSize, getSizeById} from '~/server/services/size'
...
<template>
  <UDashboardPage>
    <UDashboardPanel grow>
      <UDashboardNavbar title="Kích cỡ" :badge="totalRows">
        <template #right>
          <UInput
            ref="input"
      ...
      <UDashboardModal
        ...
        :title="state.id ? 'Cập nhật Kích cỡ' : 'Thêm mới Kích cỡ'"
      ...
      >
        ...
        >
          <UFormGroup label="Tên Kích cỡ" name="name">
            <UInput v-model="state.name" placeholder="S, M,..." autofocus/>
          </UFormGroup>

          <UFormGroup label="Mô tả" name="description">
            <UInput v-model="state.description" placeholder="S, M,..."/>
          </UFormGroup>
